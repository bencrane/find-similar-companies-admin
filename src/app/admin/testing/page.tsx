    ...
    <div className="min-h-screen bg-black">
      ...
      <header className="border-b border-gray-800 px-8 py-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-white text-xl font-bold">Testing</h1>
            <p className="text-gray-400 text-sm mt-1">Testing and development tools</p>
          </div>
        </div>
      </header>
      ...
      <main className="p-8">
        ...
        <Link href="/admin/data-engine" className="block">
          <div className="h-full rounded-xl border border-gray-800 bg-gray-900/50 p-6 cursor-pointer hover:border-gray-700 transition-colors">
            ...
            <h2 className="text-white font-semibold text-lg">Data Engine X</h2>
